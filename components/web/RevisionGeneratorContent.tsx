    ...
    const handleGenerateAiNotes = async () => {
        ...
        try {
            ...
            for (const topic of unit.topics) {
                ...
                // Save to DB
                // ID is generated by Supabase, but we need to satisfy the type. 
                // We'll pass a temp ID, the service payload ignores it for insert usually if structured right,
                // allows DB to generate. Ideally createNote should handle Omit<Note, 'id'>.
                // For now we pass a random string, app.service createNote uses payload construction.
                const newNote: Note = {
