            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 text-gray-400 gap-4">
                        ...
                        <p className="font-bold uppercase tracking-widest text-xs">Generating your sheet...</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 bg-white rounded-[40px] border border-dashed border-gray-200 text-gray-400 gap-3">
                        <Icons.Info size={32} />
