...
export function TimetableWidget({ entries }: TimetableWidgetProps) {
    ...
    return (
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[40px] border border-white shadow-[0_20px_50px_rgba(0,0,0,0.04)] space-y-10 overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h3 className="text-2xl font-black text-gray-900 tracking-tight leading-none mb-2">Academic Roadmap</h3>
